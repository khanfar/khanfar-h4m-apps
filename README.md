# KhanfarRX for PortaPack H4M

A free external app for the HackRF PortaPack H4M (Mayhem firmware): HF band plan with in-band tuning lock, and a live EIBI "on air now" shortwave station browser.
...
- **EIBI "On Air Now"**: Live EIBI shortwave schedule browser for 10 SW bands
...
- PortaPack H4M with Mayhem firmware 2.4.0 or later
- HackRF One hardware
...
- **PortaPack Mayhem Firmware** (GPL-3.0) - https://github.com/portapack-mayhem/mayhem-firmware
